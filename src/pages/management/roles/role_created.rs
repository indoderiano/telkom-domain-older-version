        ...
        self.roles.clone().iter().map(|role| {
            ...
            html! {
                <tr>
                    <td>
                        <Anchor
                            route=AppRoute::RoleSettings { tenant_id: String::from("tenantidnotfromreducer"), role_id: role.id.clone() }
                        ...
                        <div class="row">
                            ...
                            <div class="col-2">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li>
                                        <Anchor route=AppRoute::RoleSettings { tenant_id: String::from("tenantidnotfromreducer"), role_id: role.id.clone() } classes="dropdown-item fs-7">
                                            {"View Details"}
                                        </Anchor>
                                    </li>
                                    <li>
                                        <Anchor route=AppRoute::ApisSettings{tenant_id: String::from("temp_tenant_id"), api_id: String::from("api-id")} classes="dropdown-item fs-7">
                                            {"Assign To Users"}
                                        </Anchor>
                                    </li>
                                    <li>
